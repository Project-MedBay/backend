INSERT INTO _user (status, id, email, first_name, last_name, password, role) VALUES ('ACTIVE', 6000, 'admin@medbay.life', 'John', 'Doe', '$2a$12$ctrMIil.vx4xEUXMjORKZuSdCPdX8vrpX3REtxAZSahPkV.sA8ko6', 'ADMIN');
--password : password
